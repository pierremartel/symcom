...
class ProductController extends AbstractController
{
    ...
    public function index(ProductRepository $products): Response
    {
        ...
        #Les fonctions dump() et dd() dump et dire sont des fonctions de débugage similaire à var_dump.
